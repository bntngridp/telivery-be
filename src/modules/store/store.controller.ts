...
export const storeController = {
    ...
    searchStores: asyncHandler(async (req: Request, res: Response) => {
        ...
        const pagination = paginationSchema.parse(req.query);
        const result = await storeService.searchStores(query.q, pagination.page, pagination.limit);
        return paginated(
            res,
    ...
    getStoreRecommendations: asyncHandler(async (req: Request, res: Response) => {
        ...
        const stores = await storeService.getStoreRecommendations(userId, pagination.limit);
