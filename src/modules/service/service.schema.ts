...
export const createLayananSchema = z
    .object({
        ...
        estimasiDurasi: z.union([z.string(), z.number()]).optional().transform((v) => (v !== undefined ? Number(v) : undefined)),
        catatan: z.string().max(500).optional(),
    })
    .strict();

export const updateLayananSchema = createLayananSchema.partial().refine(
