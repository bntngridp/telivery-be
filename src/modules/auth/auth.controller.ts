...
export const requestSellerOtp = asyncHandler(async (req: Request, res: Response) => {
    const data = requestSellerOtpSchema.parse(req.body);
    const result = await authService.requestSellerOtp(data);
    return success(res, result.message, result);
});

export const verifyOtpAndRegisterSeller = asyncHandler(async (req: Request, res: Response) => {
...
export const registerSellerStore = asyncHandler(async (req: Request, res: Response) => {
...
export const forgotPasswordSeller = asyncHandler(async (req: Request, res: Response) => {
    const data = forgotPasswordSellerSchema.parse(req.body);
    const result = await authService.forgotPasswordSeller(data);
    return success(res, result.message, result);
});

export const verifyResetOtpSeller = asyncHandler(async (req: Request, res: Response) => {
    const data = verifyResetOtpSellerSchema.parse(req.body);
    const result = await authService.verifyResetOtpSeller(data);
    return success(res, result.message, result);
});

export const resetPasswordSeller = asyncHandler(async (req: Request, res: Response) => {
